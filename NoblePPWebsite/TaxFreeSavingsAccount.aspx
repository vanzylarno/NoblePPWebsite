<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaxFreeSavingsAccount.aspx.cs" Inherits="NoblePPWebsite.TaxFreeSavingsAccount" %>
...
<body>
  <section id="menu-1d" data-rv-view="112">
...
<section class="engine"><a href="https://mobirise.info/s">free bootstrap themes</a></section><section class="mbr-section mbr-section-hero mbr-section-full mbr-section-with-arrow mbr-parallax-background mbr-after-navbar" id="header1-22" data-rv-view="114" style="background-image: url(assets/images/forest-1598756-1920-1920x1279.jpg);">
        ...
        <div class="container">
            <div class="row">
                <div class="mbr-section col-md-10 col-md-offset-1 text-xs-center">
                    ...
                    <h1 class="mbr-section-title display-1">Tax-Free Savings Account</h1>
    ...
    <div class="mbr-arrow mbr-arrow-floating" aria-hidden="true"><a href="#header3-25"><i class="mbr-arrow-icon"></i></a></div>

</section>

<section class="mbr-section mbr-section__container article" id="header3-25" data-rv-view="117" style="background-color: rgb(45, 45, 45); padding-top: 20px; padding-bottom: 20px;">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <h3 class="mbr-section-title display-2">Tax-Free Savings Account</h3>
...
<section class="mbr-section article mbr-section__container" id="content1-24" data-rv-view="119" style="background-color: rgb(255, 255, 255); padding-top: 20px; padding-bottom: 20px;">

    <div class="container">
        <div class="row">
            <div class="col-xs-12 lead"><p>A Tax-Free savings account is an investment product that provides an investor a simple savings solution with full investment returns without being taxed on any growth earned. The Tax-Free savings account offers flexible payments and immediate access to one's funds.&nbsp;</p></div>
        </div>
    </div>

</section>

<section class="mbr-section mbr-section__container" id="buttons1-23" data-rv-view="121" style="background-color: rgb(255, 255, 255); padding-top: 20px; padding-bottom: 20px;">

    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="text-xs-center"> <a class="btn btn-primary-outline btn-primary" href="assets/files/Tax-Free%20Direct%20Clients.pdf" target="_blank">Direct Clients</a> <a class="btn btn-primary-outline btn-primary" href="assets/files/Tax-Free%20Brochure.pdf" target="_blank">Brochure</a> <a class="btn btn-primary-outline btn-primary" href="assets/files/Tax-Free%20Application%20Form.pdf" target="_blank">Application Form</a></div>
            </div>
        </div>
    </div>
...
<footer class="mbr-small-footer mbr-section mbr-section-nopadding" id="footer1-21" data-rv-view="110" style="background-color: rgb(75, 74, 74); padding-top: 0.875rem; padding-bottom: 0.875rem;">
