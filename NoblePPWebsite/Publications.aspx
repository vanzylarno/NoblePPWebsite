<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Publications.aspx.cs" Inherits="NoblePPWebsite.Publications" %>
...
<body>
    <form runat="server">
  <section id="menu-4j" data-rv-view="285">
...
<section class="engine"><a href="https://mobirise.info/q">responsive site templates</a></section><section class="mbr-section mbr-section-hero mbr-section-full mbr-section-with-arrow mbr-parallax-background mbr-after-navbar" id="header1-4l" data-rv-view="289" style="background-image: url(assets/images/analysis-1841158-1920-1920x1280.jpg);">
        ...
        <div class="container">
            <div class="row">
                <div class="mbr-section col-md-10 col-md-offset-1 text-xs-center">
                    ...
                    <h1 class="mbr-section-title display-1">Publications</h1>
    ...
    <div class="mbr-arrow mbr-arrow-floating" aria-hidden="true"><a href="#header3-4m"><i class="mbr-arrow-icon"></i></a></div>

</section>

<section class="mbr-section mbr-section__container article" id="header3-4m" data-rv-view="292" style="background-color: rgb(45, 45, 45); padding-top: 20px; padding-bottom: 20px;">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
  ...
  <section>
      <br />
      <p class="leftallign">Click on a Publication Name to start your Download!</p>
</section>
<section class="mbr-section article mbr-section__container" id="content1-4n" data-rv-view="294" style="background-color: rgb(255, 255, 255); padding-top: 20px; padding-bottom: 20px;">

    <div class="container">
        <div class="row">
            <div class="col-xs-12 lead">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="mydatagrid" OnRowCommand="GridView1_RowCommand"  HeaderStyle-CssClass="header" AllowPaging="true" OnPageIndexChanged="GridView1_PageIndexChanged" OnPageIndexChanging="GridView1_PageIndexChanging">
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
                        <asp:TemplateField HeaderText="Publication Name">
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("Publication Name") %>' CommandName="Download" Text='<%# Eval("Publication Name") %>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
...
<footer class="mbr-small-footer mbr-section mbr-section-nopadding" id="footer1-4k" data-rv-view="287" style="background-color: rgb(75, 74, 74); padding-top: 0.875rem; padding-bottom: 0.875rem;">
