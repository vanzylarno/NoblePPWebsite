...
namespace NoblePPWebsite
{
    public partial class FactSheets : System.Web.UI.Page
    {
        ...
        private void bindGridView()
        {
            ...
            dt.Columns.Add("Fact Sheet Name", typeof(string));
            dt.Columns.Add("Download Link", typeof(string));
            foreach (string strFile in Directory.GetFiles(Server.MapPath("~/FactSheets")))
            {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Download")
            {
                ...
                Response.TransmitFile(Server.MapPath("~/FactSheets/") + e.CommandArgument);
                Response.End();
            }
        }
